...
// Menu data master
    ...
    // Menu data master medis
        Route::middleware('auth')->prefix('data-master-medis')->group(function () {
            ...
            Route::get('/icd10/sync', [DataMasterMedisController::class,'icd10add'])->name('icd10.sync');
            Route::post('/icd10/delete', [DataMasterMedisController::class,'icd10delete'])->name('icd10.singkron');
