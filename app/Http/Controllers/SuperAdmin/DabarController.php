...
use App\Exports\Gudang_barang_utamaExport;
use App\Http\Controllers\Controller;
use App\Exports\Gudang_barangExport;
use App\Imports\Gudang_barang_utamaImport;
...
class DabarController extends Controller
{
    ...
    public function dabar_utama()
    {
        $title = "Data Barang Utama";
        $dabar = gudang_barang_utama::all();
        $satuan = gudang_satuan::all();
        $kategori = gudang_kategori::all();
        $singkron = external_database::all();
        return view('dashboard.dabar_utama', compact('title', 'dabar', 'satuan', 'kategori', 'singkron'));
    }
    ...
    public function dabaradd_utama(Request $request)
    {
        try {
            $request->validate([
                'kode_barang'           => 'required|string',
            ...
            // Simpan data ke database
            $satuan = gudang_barang_utama::create([
                'kode_barang' => $request->input('kode_barang'),
                'nama_barang' => $request->input('nama_barang'),
                'kfa_kode' => $request->input('kfa_kode'),
                'jenis_formularium' => $request->input('jenis_formularium'),
    ...
    public function dabaredit_utama(Request $request)
    {
        $request->validate([
            'nama_barang_edit'           => 'required|string',
            'kode_kfa_edit'              => 'required|string',
        ...
        $dabar = gudang_barang_utama::find($request->dabarid_edit);
    ...
    public function dabardelete_utama(Request $request)
    {
        ...
        $dabar = gudang_barang_utama::find($request->dabarid_delete);
    ...
    public function dabarexport_utama()
    {
        return Excel::download(new Gudang_barang_utamaExport, 'Data Gudang Barang Utama.xlsx');
    }
    ...
    public function dabarimport_utama(Request $request)
    {
        $request->validate([
            'file' => 'required|mimes:xlsx,xls'
        ]);

        Excel::import(new Gudang_barang_utamaImport, $request->file('file'));

        return redirect()->route('dabar_utama.get')->with('success', 'Data berhasil diimpor!');
    }
