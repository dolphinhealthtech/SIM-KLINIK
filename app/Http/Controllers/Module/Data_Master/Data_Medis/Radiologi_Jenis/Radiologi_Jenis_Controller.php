...
namespace App\Http\Controllers\Module\Data_Master\Data_Medis\Radiologi_Jenis;
...
class Radiologi_Jenis_Controller extends Controller
{
    public function radiologi_jenis()
    {
        ...
        return view('module.master-data.medis.radiologi-jenis.index', compact('title', 'radiologi_jenis'));
    }
