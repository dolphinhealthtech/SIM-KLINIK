...
class Perawatan_Tindakan_Controller extends Controller
{
    ...
    public function perawatan_tindakan()
    {
        ...
        return view('module.master-data.medis.perawatan-tindakan.index', compact('title', 'perawatan_tindakan', 'kategori'));
    }
