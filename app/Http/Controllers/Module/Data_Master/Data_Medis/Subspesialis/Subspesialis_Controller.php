...
namespace App\Http\Controllers\Module\Data_Master\Data_Medis\Subspesialis;
...
class Subspesialis_Controller extends Controller
{
    ...
    public function subspesialis($kode)
    {
        ...
        // spesialis
        return view('module.master-data.medis.subspesialis.index', compact('title', 'subspesialis', 'kode'));
    }
