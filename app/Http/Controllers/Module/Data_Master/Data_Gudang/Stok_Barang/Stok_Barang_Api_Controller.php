...
class Stok_Barang_Api_Controller extends Controller
{
    // API untuk Penyesuaian Stok Cabang
    ...
    // API untuk Kartu Stok Masuk Cabang
    ...
    // API untuk Kartu Stok Keluar Cabang
