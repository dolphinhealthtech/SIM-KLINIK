...
class Staff_Controller extends Controller
{
    public function staff()
    {
        ...
        return view('module.sdm.staff.index', compact('title', 'user', 'poli', 'posker', 'dokter', 'provinsi', 'kelamin', 'goldar', 'agama', 'pernikahan', 'suku', 'bangsa', 'bahasa', 'pendidikan', 'bank', 'dokternoverif', 'dokterall'));
    }
