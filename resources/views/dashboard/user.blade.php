                                    ...
                                    @foreach ($users as $usersdata)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" class="btn btn-sm non-data-users {{ $usersdata->is_active ? 'btn-warning' : 'btn-success' }}"
                                                    data-toggle="modal"
                                                ...
                                                <a href="#" class="btn btn-danger btn-sm delete-data-users" data-toggle="modal"data-id="{{ $usersdata->id }}" data-nama-users="{{ $usersdata->name }}" data-target="#deleteusersModal">
                                                    <i class="fas fa-trash"></i> Delete
                                                </a>
                                                <a href="#" class="btn btn-info btn-sm give-data-role" data-toggle="modal" data-id="{{ $usersdata->id }}" data-roles="{{ json_encode($usersdata->roles->pluck('name')->toArray()) }}" data-target="#giveroleModal">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Role</label>
                                <select class="form-control select2bs4" id="role-give" name="role-give[]" multiple="multiple" style="width: 100%;">
