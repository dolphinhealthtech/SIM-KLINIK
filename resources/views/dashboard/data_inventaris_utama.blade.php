    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Inventaris Gudang Utama</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    ...
                                    <!-- Tombol Export -->
                                    <a href="{{ route('inventaris_utama.export') }}" class="btn btn-success">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForminventaris" action="{{ route('inventaris_utama.store') }}" method="POST">
                    @csrf
                    <div class="row">
...
<div class="modal fade" id="editinventarisModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForminventaris" action="{{ route('inventaris_utama.update') }}" method="POST">
                    @csrf
...
<div class="modal fade" id="deleteinventarisModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
    <div class="modal-dialog">
        <form id="deleteForminventaris" action="{{ route('inventaris_utama.destroy') }}" method="POST">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="importinventarisModal" tabindex="-1" role="dialog" aria-labelledby="importinventarisModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('inventaris_utama.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
