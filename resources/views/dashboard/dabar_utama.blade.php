    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Daftar Obat Gudang Utama</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Obat Gudang Utama</h3>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addFormdabar" action="{{ route('dabar_utama.store') }}" method="POST">
                    @csrf
...
<div class="modal fade" id="editdabarModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editFormdabar" action="{{ route('dabar_utama.update') }}" method="POST">
                    @csrf
...
<div class="modal fade" id="deletedabarModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
    <div class="modal-dialog">
        <form id="deleteFormdabar" action="{{ route('dabar_utama.destroy') }}" method="POST">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="importdabarModal" tabindex="-1" role="dialog" aria-labelledby="importdabarModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('dabar_utama.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
