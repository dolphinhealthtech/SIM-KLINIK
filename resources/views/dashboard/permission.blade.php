                                    ...
                                    @foreach ($permission as $permissiondata)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" class="btn btn-warning btn-sm edit-data-permission" data-toggle="modal" data-id="{{ $permissiondata->id }}" data-nama-permission="{{ $permissiondata->name }}" data-target="#editpermissionModal">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="#" class="btn btn-danger btn-sm delete-data-permission" data-toggle="modal"data-id="{{ $permissiondata->id }}" data-nama-permission="{{ $permissiondata->name }}" data-target="#deletepermissionModal">
                ...
                <form id="editFormpermission" action="{{ route('permission.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Nama permission</label>
                                <input type="text" class="form-control" id="permissionname_update" name="permissionname_update">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
{{-- modal Delete Role --}}
<div class="modal fade" id="deletepermissionModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
...
<script>
    ...
    $(document).on('click', '.delete-data-permission', function() {
        ...
        $('#deleteTextpermission').html(`<span>Apa Anda yakin ingin menghapus data Permission <b>${name}</b>?</span>`);
    });
