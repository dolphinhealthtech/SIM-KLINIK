    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Stok Barang Inventaris</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Stok Barang Inventaris</h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        @foreach ($stok_inventaris as $stok_inventarisdata)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('stokin_data.get', ['id' => $stok_inventarisdata->kode_pembelian, 'kode' => $stok_inventarisdata->kode_barang]) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-clipboard-list"></i> Detail Data</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
