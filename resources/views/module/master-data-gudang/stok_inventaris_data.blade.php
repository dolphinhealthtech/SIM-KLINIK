    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Stok Inventaris Data</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm_data_stok_inventaris" action="{{ route('stokin_data.update') }}" method="POST">
                    @csrf
                    <div class="row">
...
<div class="modal fade" id="delete_data_stok_inventaris" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
    <div class="modal-dialog">
        <form id="deleteForm_stok_inventaris" action="{{ route('stokin_data.destroy') }}" method="POST">
            <div class="modal-content">
                <div class="modal-header">
