...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pendataan Pendaftaran</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="pendaftaranTable" class="table table-bordered table-striped thin-table-border kasir-table" style="min-width: 1500px">
                                    <thead>
                                        <tr>
...
<script>
    const pendaftaranData = @json($data);
    ...
    $(document).ready(function() {
        ...
        let table = $('#pendaftaranTable').DataTable({
            ...
            columns: [
                ...
                { data: 'antrian', className: "text-center" },
            ],
            paging: true,
            lengthChange: true,
            searching: true,
        ...
        $('#btnPrint').on('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var form = $('<form>', {
                        method: 'POST',
                        action: "{{ route('print_pendaftaran') }}",
                        target: '_blank'
                    });
