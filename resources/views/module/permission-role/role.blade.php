                                        ...
                                        @foreach ($role as $roledata)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-warning btn-sm edit-data-role"
                                                        data-toggle="modal" data-id="{{ $roledata->id }}"
                                                        data-nama-role="{{ $roledata->name }}" data-target="#editroleModal">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm delete-data-role"
                                                        data-toggle="modal"data-id="{{ $roledata->id }}"
                                                    ...
                                                    <a href="#" class="btn btn-info btn-sm give-role-permission"
                                                        data-toggle="modal" data-id="{{ $roledata->id }}"
                                                        data-nama-role="{{ $roledata->name }}"
                                                        data-permissions='@json($roledata->permissions->pluck('name'))'data-target="#giveRolePermissionModal">
                    ...
                    <form id="editFormrole" action="{{ route('role.update') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Nama Role</label>
                                    <input type="text" class="form-control" id="rolename_update"
                                        name="rolename_update">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
