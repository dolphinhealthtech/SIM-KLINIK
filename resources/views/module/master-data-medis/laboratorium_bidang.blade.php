                                        ...
                                        @foreach ($laboratorium_bidang as $laboratorium_bidangdata)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{ route('htt_sub_pemeriksaan.get', ['kode' => $laboratorium_bidangdata->id]) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-briefcase-medical"></i> Sub Pemeriksaan</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
