...
@section('content')
    <div class="content-wrapper">
        ...
        @include('module.sdm.dokter.components.modal-add')
        @include('module.sdm.dokter.components.modal-edit')
        @include('module.sdm.dokter.components.modal-delete')
        @include('module.sdm.dokter.components.modal-verifikasi')
        @include('module.sdm.dokter.components.modal-jadwal-dokter')
        @include('module.sdm.dokter.components.javascript')
