    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h5 class="text-muted text-center">Selamat datang di modul data master Bangsa</h5>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
@include('module.master-data.umum.bangsa.components.modal-add')

@include('module.master-data.umum.bangsa.components.modal-edit')

@include('module.master-data.umum.bangsa.components.modal-delete')

@include('module.master-data.umum.bangsa.components.modal-import')

@include('module.master-data.umum.bangsa.components.modal-delete')
@include('module.master-data.umum.bangsa.components.modal-import')
@include('module.master-data.umum.bangsa.components.javascript')
@endsection
