...
@include('module.master-data.loket.components.modal-add')
@include('module.master-data.loket.components.modal-edit')
@include('module.master-data.loket.components.modal-delete')
@include('module.master-data.loket.components.modal-import')
@include('module.master-data.loket.components.javascript')
