...
{{-- modal Add Role --}}
<div class="modal fade" id="addbahasaModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Tambah Master Data bahasa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="addFormbahasa" action="{{ route('bahasa.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Nama bahasa</label>
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama bahasa" required>
                            </div>
                        </div>
                    </div>
            </div>
...
<div class="modal fade" id="editbahasaModa" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Master Data bahasa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span>&times;</span>
                </button>
            </div>
...
{{-- modal Delete Role --}}
<div class="modal fade" id="deletebahasaModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
...
<!-- Modal Import -->
<div class="modal fade" id="importbahasaModal" tabindex="-1" role="dialog" aria-labelledby="importbahasaModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importbahasaModalLabel">Import Data bahasa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('bahasa.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
...
<script>
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Gagal!',
                        text: 'Terjadi kesalahan saat mengupdate bahasa!',
                    });
                }
            });
        });
        ...
        $(document).on('click', '.delete-data-bahasa', function() {
            ...
            $('#deleteTextbahasa').html(
            `<span>Apa Anda yakin ingin menghapus data bahasa <b>${name}</b> ?</span>`);
        });
