...
@section('content')
    ...
    @include('module.master-data.kelamin.components.modal-add')
    @include('module.master-data.kelamin.components.modal-edit')
    @include('module.master-data.kelamin.components.modal-delete')
    @include('module.master-data.kelamin.components.modal-import')
    @include('module.master-data.kelamin.components.javascript')
