...
@include('module.master-data.bank.components.modal-add')
@include('module.master-data.bank.components.modal-edit')
@include('module.master-data.bank.components.modal-delete')
@include('module.master-data.bank.components.modal-import')
@include('module.master-data.bank.components.javascript')
