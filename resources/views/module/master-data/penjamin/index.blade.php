...
@include('module.master-data.penjamin.components.modal-add')
@include('module.master-data.penjamin.components.modal-edit')
@include('module.master-data.penjamin.components.modal-delete')
@include('module.master-data.penjamin.components.modal-import')
@include('module.master-data.penjamin.components.javascript')
