...
@include('module.master-data.bahasa.components.modal-add')

@include('module.master-data.bahasa.components.modal-edit')

@include('module.master-data.bahasa.components.modal-delete')

@include('module.master-data.bahasa.components.modal-import')
@include('module.master-data.bahasa.components.javascript')
@endsection
