...
@section('content')
	...
	@include('module.master-data.pendidikan.components.modal-add')
	@include('module.master-data.pendidikan.components.modal-edit')
	@include('module.master-data.pendidikan.components.modal-delete')
	@include('module.master-data.pendidikan.components.modal-import')
	@include('module.master-data.pendidikan.components.javascript')
