...
@section('content')
	...
	@include('module.master-data.pekerjaan.components.modal-add')
	@include('module.master-data.pekerjaan.components.modal-edit')
	@include('module.master-data.pekerjaan.components.modal-delete')
	@include('module.master-data.pekerjaan.components.modal-import')
	@include('module.master-data.pekerjaan.components.javascript')
