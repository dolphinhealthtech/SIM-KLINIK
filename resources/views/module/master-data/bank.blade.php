    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Tambah Master Data bank</h5>
...
<div class="modal fade" id="editbankModa" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Master Data bank</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span>&times;</span>
                </button>
            </div>
...
{{-- modal Delete Role --}}
<div class="modal fade" id="deletebankModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
    <div class="modal-dialog">
        <form id="deleteFormbank" action="{{ route('bank.destroy') }}" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @csrf
                    <input type="hidden" id="bankid_delete" name="bankid_delete">
                    <div id="deleteTextbank"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
...
<!-- Modal Import -->
<div class="modal fade" id="importbankModal" tabindex="-1" role="dialog" aria-labelledby="importbankModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importbankModalLabel">Import Data bank</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
