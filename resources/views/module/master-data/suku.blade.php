...
{{-- modal Add Role --}}
<div class="modal fade" id="addsukuModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Tambah Master Data Suku</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama suku" required>
                            </div>
                        </div>
                    </div>
            </div>
...
{{-- modal Edit Role --}}
<div class="modal fade" id="editsukuModa" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Master Data Suku</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="editFormsuku" action="{{ route('suku.update') }}" method="POST">
                    @csrf
                    <input type="hidden" id="sukuid_edit" name="sukuid_edit">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
...
<div class="modal fade" id="deletesukuModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
    <div class="modal-dialog">
        <form id="deleteFormsuku" action="{{ route('suku.destroy') }}" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Hapus Master Data Suku</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span>&times;</span>
                    </button>
                </div>
...
<!-- Modal Import -->
<div class="modal fade" id="importsukuModal" tabindex="-1" role="dialog" aria-labelledby="importsukuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importsukuModalLabel">Import Data Suku</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('suku.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
