                    ...
                    <div class="card mb-4 video-card">
                        ...
                        <div class="card-body p-0" style="flex: 1; overflow: hidden;">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/your-video-id?autoplay=1&mute=1&loop=1&playlist=your-video-id" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card announcement-card-container">
                        ...
                        <div class="card-body p-2" style="overflow: hidden;">
                            <div class="announcement-card p-2">
                                <h4 class="mb-1"><i class="fas fa-info-circle mr-1 text-theme-primary"></i> Perhatian</h4>
                                <p class="mb-0">Mohon perhatikan nomor antrian Anda. Pastikan Anda berada di area tunggu saat nomor Anda mendekati giliran.</p>
                            </div>
                        </div>
                    </div>
                </div>
