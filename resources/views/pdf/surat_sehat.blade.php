...
<body>
    ...
    <p class="teks">Berdasarkan pemeriksaan yang telah dilakukan pada
        {{ $tgl_periksa ? \Carbon\Carbon::parse($tgl_periksa)->format('d-m-Y H:i') : '-' }}, yang bersangkutan
        dinyatakan SEHAT dengan hasil pemeriksaan sebagai berikut :</p>
    ...
    <p class="teks">Demikian surat sehat ini dibuat dengan sebenar-benarnya dan untuk dipergunakan sebagai mestinya.
    </p>
